	...
	<div>
		...
		<?php
			$sql = "SELECT * FROM `user` 
					INNER JOIN galleryimages ON galleryimages.userid = user.id
					INNER JOIN profileimages ON profileimages.profileUserId = galleryimages.userid
											...
											<div class="media">
												<div class="media-left">
													<figure class="image is-48x48">
														<img src="./profile_images/'.$row['profilePath'].'" alt="Placeholder image">
													</figure>
												</div>
